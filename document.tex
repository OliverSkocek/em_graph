...
\begin{definition}
	Sei $G$ ein planarer Graph $m>0$ und $\Phi_0$ sowie $v_0$ Kurven von komplexen Eckfunktionen, dann nennt man $\Phi\in C^1(\mathfrak{E}, \mathbb{C})$ eine L\"osung der \textbf{Klein-Gordongleichung} falls f\"ur alle $t\in\mathbb{R}$ gilt
	\begin{equation}
...
\end{proof}
\noindent
Die Ladung $q$ und der Strom $j$ sind die Me\ss{}gr\"o\ss{}en der Klein-Gordon Theorie, w\"ahrend $\Phi$ einem Potential entspricht.
\\
\\
