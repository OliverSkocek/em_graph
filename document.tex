...
\begin{definition}
Sei $G$ ein planarer Graph, $r>0$, $\epsilon$,  Kantenfunktionen, $j\in C^1(\mathbb{R}, \mathfrak{K})$, $\mu$ eine Fl\"achenfunktion und $a$ und $\phi$ L\"osungen der Maxwellgleichung in Potentialform (4.9), dann nennt man 
\begin{equation}
	L(\phi, A, \phi^\prime, A^\prime) =
\end{equation}
\end{definition}
