...
\begin{align*}
	L(q_1, q_2, v_1, v_2) =&\frac{1}{2}(\langle \epsilon(v_2 + r\text{grad}(q_1)), v_2 + r\text{grad}(q_1)\rangle_\mathfrak{K} -\\& \langle\text{div}_D(r^{-1}q_2), \text{div}_D(r^{-1}q_2)/\mu\rangle_\mathfrak{K}) + \langle q_2, j\rangle_\mathfrak{K} - \langle q_1, q\rangle_\mathfrak{E}
\end{align*}
\end{theorem}
\begin{proof}
...
\end{align*}
Hiermit wurde gezeigt, dass sich der Imagin\"arteil im Bild der Divergenz befindet und somit mit $\text{div}\text{div}^{-1}$ erweiter werden kann, was uns zum gesuchten Resultat f\"uhrt.
\begin{equation*}
...
\begin{align*}
	L(\phi, a, \Phi, \phi^\prime, a^\prime, \Phi^\prime) =&\frac{1}{2}(\langle \overline{\Phi^\prime}, \Phi^\prime\rangle_{\mathfrak{E}}-
	\langle \overline{\text{grad}^A(\Phi)}, \text{grad}^A(\Phi)\rangle_{\mathfrak{K}} - m^2\langle \overline{\Phi}, \Phi\rangle_{\mathfrak{E}}+ \\
	&\langle \epsilon(a^\prime + r\text{grad}(\phi)), a^\prime + r\text{grad}(\phi)\rangle_\mathfrak{K} -\\& \langle\text{div}_D(r^{-1}a), \text{div}_D(r^{-1}a)/\mu\rangle_\mathfrak{K})
\end{align*}
\chapter*{Abschluss}
