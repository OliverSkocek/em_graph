...
\begin{definition}
	Sei $G$ ein planarer Graph, $A$ die Fl\"achen von $G$, $r>0\in \mathfrak{K}(G)$, $Q$ die Pseudoinverse von $r\text{grad}$, $u:\mathfrak{K}(G)\rightarrow \mathbb{C}^{|A|-1}$, sodass $uu^T=1_{\mathbb{C}^{|A|-1}}$ und $u^Tu=P_{\text{kern}(\text{div r})}$ und  $v:\mathfrak{K}(G)\rightarrow \mathbb{C}^{|A|-1}$, sodass $vv^T=1_{\mathbb{C}^{|V|-1}}$ und $v^Tv=P_{\text{kern}(\text{div}_D\text{ r})}$\footnote{Die Spalten von $u$ und $v$ sind einfach orthogonale Basen der entsprechenden Teilr\"aumen.} dann definieren wir eine Abbildung $\gamma:\mathfrak{E}_\mathbb{C}(G)\times\mathfrak{K}(G)\rightarrow  \mathfrak{E}_\mathbb{C}(G)\times\mathbb{C}^{|A|-1}\times\mathbb{C}^{|V|-1}$ durch
	\begin{equation}
		\gamma(\Phi, a) = (\Phi e^{-iQ(a)}, u(a), v(a))
	\end{equation}
f\"ur alle $\Phi\in\mathfrak{E}_\mathbb{C}(G)$ und $a\in\mathfrak{K}(G)$.\\
\\
Die Abbildung $\gamma$ induziert eine Abbildung $\Gamma:F(\mathfrak{E}_\mathbb{C}(G)\times\mathbb{C}^{|A|-1}\times\mathbb{C}^{|V|-1}, \mathbb{C})\rightarrow F(\mathfrak{E}_\mathbb{C}(G)\times\mathfrak{K}(G), \mathbb{C})$ definiert durch.
\begin{equation}
	\Gamma(f)=f\circ\gamma
\end{equation}
f\"ur alle Funktionen $f\in F(\mathfrak{E}_\mathbb{C}(G)\times\mathbb{C}^{|A|-1}\times\mathbb{C}^{|V|-1}, \mathbb{C})$.
\end{definition}
\begin{lemma}
...
\end{proof}
\begin{proposition}
	Sei $G$ ein planarer Graph, $\Gamma$ wie in Definition 10.4 und $\psi\in F(\mathfrak{E}_\mathbb{C}(G)\times\mathfrak{K}(G), \mathbb{C})$, dann ist $\psi$ genau dann invariant unter $\hat{U}_\xi$ f\"ur beliebiges $\xi\in\mathfrak{E}(G)$ mit $\sum_{x\in V}\xi(x)=0$ falls es ein $f\in F(\mathfrak{E}_\mathbb{C}(G)\times\mathbb{C}^{|A|-1}, \mathbb{C})$\footnote{Also dass es ein $f\in F(\mathfrak{E}_\mathbb{C}(G)\times\mathbb{C}^{|A|-1}\times\mathbb{C}^{|V|-1}, \mathbb{C})$ gibt sodass $f$ konstant entlang $\mathbb{C}^{|V|-1}$ ist.} gibt sodass $\psi=\Gamma(f)$.
\end{proposition}
\begin{proof}
