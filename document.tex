...
Alternativ h\"atten wir vor der Quantisierung den ladungsfreien Fall
 ...
 \begin{equation}
	\text{div}(r * \epsilon * a) = 0
\end{equation}
Die Transformation $U$ und das eliminieren der ersten $|V| - 1$ Koordinaten h\"atte zu einer Hamiltonfunktion gef\"uhrt die durch Quantisierung zur gesuchten Schr\"odingergleichung f\"uhrt.\\
\\
Es folgt also, dass das freie elektromagnetische Feld seine Energie nur in ganzzahligen Vielfachen der Frequenz aufnehmen und abgaben kann. Bewiesen wurde quasi
\begin{equation}
	E = h*f
\end{equation}
...
\begin{proposition}
	Sei $G$ ein planarer Graph, $m>0$ eine reele Zahl, $r>0$ eine Kantenfunktion und $\Phi$ eine L\"sung der Klein-Gordongleichung zur Anfangsbedingung $\phi_0\in\mathfrak{E}$ , dann gilt die Kontinuit\"atsgleichung:
	\begin{equation}
		q^\prime + \text{div}(j) = 0 
	\end{equation}
...
\end{proposition}
\begin{proof}
Starten mir bei der linken Seite von (8.4)
\begin{align*}
	&q^\prime = (\Im(\overline{\Phi}\Phi^\prime))^\prime=(\frac{\overline{\Phi}\Phi^\prime - \Phi\overline{\Phi}^\prime}{2})^\prime=\\
	&\frac{1}{2}((\overline{\Phi^\prime}\Phi^\prime + \overline{\Phi}\Phi^{\prime\prime})-(\Phi^\prime\overline{\Phi}^\prime+\Phi\overline{\Phi}^{\prime\prime}))=\\
	&\frac{1}{2}(\overline{\Phi}\Phi^{\prime\prime}-\Phi\overline{\Phi}^{\prime\prime})=
	\frac{1}{2}(\overline{\Phi}(\Delta_{r^{-2}}\Phi - m \Phi)-\Phi\overline{(\Delta_{r^{-2}}\Phi - m \Phi)})=\\
	&\frac{1}{2}(\overline{\Phi}\Delta_{r^{-2}}\Phi-\Phi\Delta_{r^{-2}}\overline{\Phi})=\Im(\overline{\Phi}\Delta_{r^{-2}}(\Phi))
\end{align*}
...
\begin{proposition}
	Sei $G$ ein planarer Graph $m>0$ eine reele Zahl, $r>0$ eine Kantenfunktion, $\Phi_0$ sowie $v_0$ komplexe Eckfunktionen und $\pi,\Phi\in C^1(\mathfrak{E}, \mathbb{C})$, dann nennt man
	\begin{equation}
	H(\Phi, \pi) = \frac{1}{2}(\langle \pi, \pi\rangle_{\mathfrak{E}}+\langle r^{-1}\text{grad}(\Phi), r^{-1}\text{grad}(\Phi)\rangle_{\mathfrak{K}}+m^2\langle \Phi,\Phi\rangle_{\mathfrak{E}})
	\end{equation}	
	...
	\begin{align}
		\Phi^\prime = \frac{\partial H}{\partial \pi}\\
		\pi^\prime = - \frac{\partial H}{\partial \Phi}
