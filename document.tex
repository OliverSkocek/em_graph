...
\begin{definition}
	Sei $G$ ein planarer Graph $m>0$ eine reele Zahl und $\Phi_0$ sowie $v_0$ komplexe Eckfunktionen, dann nennt man $\Phi\in C^1(\mathfrak{E}, \mathbb{C})$ eine L\"osung der \textbf{Klein-Gordongleichung} falls f\"ur alle $t\in\mathbb{R}$ gilt
	\begin{equation}
		\Phi^{\prime \prime} - \Delta_1\Phi+ m \Phi = 0
	\end{equation}
...
\begin{proposition}
	Sei $G$ ein planarer Graph $m>0$ und $\Phi$ eine L\"sung der Klein-Gordongleichung zur Anfangsbedingung $\phi_0\in\mathfrak{E}$ , dann gilt die Kontinuit\"atsgleichung:
	\begin{equation}
		q^\prime + \text{div}(j) = 0 
	\end{equation}
	...
	\begin{align}
		...
		&j = -\text{div}^{-1}\Im(\overline{\Phi}\Delta_1(\Phi))
	\end{align}
\end{proposition}
\begin{proof}
...
\begin{align*}
	...
	\frac{1}{2}(\overline{\Phi}(\Delta_1\Phi - m \Phi)-\Phi\overline{(\Delta_1\Phi - m \Phi)})=\\
	&\frac{1}{2}(\overline{\Phi}\Delta_1\Phi-\Phi\Delta_1\overline{\Phi})=\Im(\overline{\Phi}\Delta_1(\Phi))
\end{align*}
...
\begin{align*}
	&\sum_{v\in V} \Im(\overline{\Phi}\Delta_1\Phi)(v)=\sum_{v\in V} (a(v)\Delta_1b(v) - b(v)\Delta_1 a(v))=\langle a,\Delta_1b\rangle_{\mathfrak{E}}-\langle b ,\Delta_1a\rangle_{\mathfrak{E}}=\\
	&-\langle \text{grad}(a),\text{grad}(b)\rangle_{\mathfrak{E}}+\langle \text{grad}(b) ,\text{grad}(a)\rangle_{\mathfrak{E}}=0
\end{align*}
...
\begin{equation*}
	q^\prime =\Im(\overline{\Phi}\Delta_1(\Phi))=\text{div}(\text{div}^{-1}(\Im(\overline{\Phi}\Delta_1(\Phi))))
\end{equation*}
\end{proof}
\noindent
...
\begin{proposition}
	Sei $G$ ein planarer Graph $m>0$ eine reele Zahl, $\Phi_0$ sowie $v_0$ komplexe Eckfunktionen und $\pi,\Phi\in C^1(\mathfrak{E}, \mathbb{C})$, dann nennt man
	\begin{equation}
	H(\Phi, \pi) = \frac{1}{2}(\langle \pi, \pi\rangle_{\mathfrak{E}}+\langle \text{grad}(\Phi), \text{grad}(\Phi)\rangle_{\mathfrak{E}}+m^2\langle \Phi,\Phi\rangle_{\mathfrak{E}})
	\end{equation}	
...
\begin{definition}
	Sei $G$ ein planarer Graph, $m>0$ $\mathfrak{H}(G)$, dann ist der der Hamiltonoperator des Klein-Gordon Feldes gegeben durch:
	\begin{equation}
		\hat{H}=-\sum_{k\in V}\frac{1}{2}\frac{\partial^2}{\partial q_k^2} + \frac{1}{2}(\langle \text{grad}(\Phi), \text{grad}(\Phi)\rangle_{\mathfrak{E}}+ m^2\langle\Phi, \Phi\rangle_{\mathfrak{E}})
	\end{equation}
	Sei $\psi_0\in\mathfrak{H}$ und $\psi\in C^1(\mathbb{R},\mathfrak{H})$, sodass:
	\begin{equation}
		\hat{H}\psi(t) = i\psi^\prime(t)
