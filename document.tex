...
\begin{proof}
	...
	\begin{align*}
		\langle u, e^{i\xi}\Delta_r^a(\Phi)\rangle = &\langle r^{-1}\text{grad}^{\frac{a}{r}}e^{-i\xi}u, r^{-1}\text{grad}^{\frac{a}{r}}(\Phi)\rangle\\
		&\langle r^{-1}\text{grad}^{\frac{a}{r}}e^{-i\xi}u, r^{-1}\text{grad}^{\frac{a}{r}}(\Phi)\rangle
	\end{align*}
	Anschlie\ss{}end erweitern wir den Skalarproduktausdruck mit $e^{i\xi(p(\tilde{e}))}$ und wenden anschlie\ss{}end Hilfssatz 7.2 an
	\begin{align*}
		&\langle r^{-1}e^{i\xi(p(\tilde{e}))}\text{grad}^{\frac{a}{r}}e^{-i\xi}u, r^{-1}e^{i\xi(p(\tilde{e}))}\text{grad}^{\frac{a}{r}}(\Phi)\rangle=\\
		&\langle r^{-1}\text{grad}^{\frac{a + r\text{grad}\xi}{r}}u, r^{-1}\text{grad}^{\frac{a + r\text{grad}\xi}{r}}(e^{i\xi}\Phi)\rangle=
		\langle u, \Delta_r^{a + r\text{grad}\xi}(e^{i\xi}\Phi)\rangle
	\end{align*}
	Wir haben somit gezeigt:
		\begin{equation*}
		\langle u, e^{i\xi}\Delta_r^a(\Phi) - \Delta_r^{a + r\text{grad}\xi}(e^{i\xi}\Phi)\rangle = 0
	\end{equation*}
