...
\begin{proof}
	...
	$$(\max_{x\notin\partial}\frac{\sum_{k\in E}\sqrt{r}(k)}{\sqrt{r}})^2*(\sum_{i=1}^{n-1} \sigma_i *\frac{\sqrt{r}}{\sum_{k\in E}\sqrt{r}(k)}\text{grad}(u)(e_i))^2$$
	Wende die Jensen Ungleichung an und fasse zusammen:
	$$u(x)^2\leq (\max_{x\notin\partial}\frac{\sum_{k\in E}\sqrt{r}(k)}{\sqrt{r}})^2*\sum_{i=1}^{n-1} (\frac{\sqrt{r}}{\sum_{k\in E}\sqrt{r}(k)}\text{grad}(u)(e_i))^2=$$
	$$(\max_{x\notin\partial}\frac{1}{r})*\sum_{i=1}^{n-1} (\sqrt{r}\text{grad}(u)(e_i))^2$$
	Summieren wir nun \"uber $V$:
	$$\langle u, u\rangle_{\mathfrak{E}}\leq |V|(\max_{x\notin\partial}\frac{1}{r})\langle \sqrt{r}\text{grad}(u), \sqrt{r}\text{grad}(u)\rangle_{\mathfrak{K}}=$$
	$$\frac{|V|}{\min_{x\notin\partial}r(x)} \langle \text{grad}(u), r*\text{grad}(u)\rangle_{\mathfrak{K}}=\frac{|V|}{\min_{x\notin\partial}r(x)} \langle u, \Delta_r(u)\rangle_{\mathfrak{E}}$$
\end{proof}
\noindent
