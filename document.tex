...
\begin{align*}
\text{Bild}(r\text{grad}) &= r\text{grad}(\{\phi\in\mathfrak{E}(G):\sum_{x\in V}\phi_x=0, -\pi\leq\phi<\pi\} \\&+ 2\pi\{\sum_{V-\{z\}}n_i*f_x: n\in \mathbb{Z}^{V-\{z\}}\})\\
&=\mathfrak{T} + 2\pi\{\sum_{V-\{z\}}n_i*r\text{grad}(f_x): n\in \mathbb{Z}^{V-\{z\}}\}
\end{align*}
...
\end{proof}
\noindent
Wir können nun das zentrale Theorem dieses Kapitels beweisen, n\"amlich die L\"osbarkeit der Schr\"odingergleichung der Quantenelektrodynamik
\begin{theorem}
...
\end{proof}
\noindent
\chapter{Numerische Simulation der Quantenelektrodynamik auf einem Ikosaeder}
\chapter*{Abschluss}
