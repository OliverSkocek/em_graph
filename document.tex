...
\end{theorem}
\begin{proposition}
	Sei $G$, $m>0$, $r>0$ und $\Phi$ wie in Definition 7.3 und $a$, $\Phi_0$ und $v_0$ Kantenfunktionen, dann gibt es eine lineare Abbildung $L:\mathbb{C}^2\rightarrow\mathbb{C}^2$
	...
	dann gibt es eine eindeutige L\"osung des Anfangswertproblems.
	\begin{align}
		\frac{\partial^2}{\partial t^2}\Phi - \Delta^{a}_r\Phi&+ m^2 \Phi = 0\\
		\Phi(0)&=\Phi_0\\
		\Phi^\prime(0)&=v_0
