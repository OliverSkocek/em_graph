...
\begin{align*}
	...
	&\frac{1}{2}(\overline{\Phi}\Delta_1\Phi-\Phi\Delta_1\overline{\Phi})
\end{align*}
Der letzte Term muss sich im Bild der Divergenz befinden um die Inverse der Divergenz darauf anzuwenden. Dies ist nach dem de'Rham Komplex Theorem genau dann der Fall wenn die Summe der Eckfunktion \"uber alle Ecken gleich Null ist. Sei hierzu  $\Phi(e)=a(e)+ib(e)$ f\"ur alle $e\in E$ und beachte, dass $\Delta_1$ komponentenweise angewendet wird, dann gilt f\"ur den Realteil
\begin{equation*}
	\sum_{e\in E} \Re(\overline{\Phi}\Delta_1\Phi)=\sum_{e\in E} a(e)\Delta_1a(e) + b(e)\Delta_1b(e)=\sum_{e\in E} \Re(\Phi\Delta_1\overline{\Phi})
\end{equation*}
und f\"ur den Imagin\"arteil
\begin{align*}
	&\sum_{e\in E} \Im(\overline{\Phi}\Delta_1\Phi)=\sum_{e\in E} a(e)\Delta_1b(e) - b(e)\Delta_1a(e)=\\
	&\langle a,\Delta_1b\rangle_{\mathfrak{E}}-\langle b ,\Delta_1a\rangle_{\mathfrak{E}}=-\langle \text{grad}(a),\text{grad}(b)\rangle_{\mathfrak{E}}+\langle \text{grad}(b) ,\text{grad}(a)\rangle_{\mathfrak{E}}=\\
	&\sum_{e\in E} \Im(\Phi\Delta_1\overline{\Phi})
\end{align*}
\end{proof}
\noindent
