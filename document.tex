...
\begin{align*}
\text{Bild}(r\text{grad}) &= r\text{grad}(\{\phi\in\mathfrak{E}(G):\sum_{x\in V}\phi_x=0, -\pi\leq\phi<\pi\} \\&+ 2\pi\{\sum_{i\in(V-\{z\})}n_i*f_x: n\in \mathbb{Z}^{V-\{z\}}\})\\
&=\mathfrak{T} + 2\pi\{\sum_{i\in(V-\{z\})}n_i*r\text{grad}(f_x): n\in \mathbb{Z}^{V-\{z\}}\}
\end{align*}
...
\begin{equation}
	a_1 = a_0 + 2\pi \sum_{V-\{z\}}n_i*r\text{grad}(f_x)
\end{equation}
damit gilt
\begin{align*}
	e^{-iQ(a_1)}=e^{-i(Q(a_0) + 2\pi \sum_{V-\{z\}}n_if_x)}=e^{-i(Q(a_0)}
\end{align*}
