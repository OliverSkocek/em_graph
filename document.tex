...
Sei $\phi, \psi \in \Omega$, dann verwenden wir partielle Integration um zu zeigen, dass (6.32) der Definition der Adjungierten entspricht:
\begin{align*}
...
\begin{proof}
	...
	\\
	Kommen wir nun zur Vertauschungsrelation (6.35)
	\begin{align*}
...
\end{proposition}
\begin{proof}
	Nachdem der Teilchenzahloperator $\hat{N}_\omega =\hat{a}^\dagger_\omega\hat{a}_\omega\geq 0$ gilt, ist auch $\sigma(\hat{N}_\omega)\geq 0$.\\
	\\
	...
	\end{equation*}
und somit $\hat{N}_\omega\psi_0=0$.\\
\\
...
\\
Somit haben wir mit $\psi_0$ und mit $\psi_k= \hat{a}_\omega^k\psi_0$ wobei $k\in\mathbb{N}$, zu jedem Element von $\mathbb{N}\cup\{0\}$ einen Eigenvektor konstruiert.\\
\\
\end{proof}
