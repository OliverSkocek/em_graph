...
\begin{proposition}
	...
	\begin{align}
		...
		j &= -\text{div}^{-1}\Im(\overline{\Phi}\Delta^a_r(\Phi))\\
		  &= \Im(\frac{1}{r(e)^2} \overline{\Phi(p(e))}\phi(q(e))e^{\frac{a}{r}(e)})\nonumber
	\end{align}
\end{proposition}
\begin{proof}
...
\end{equation*}
Wir starten mit dem Ausdruck f\"ur die Divergenz des Stromes $\Im(\overline{\Phi}(x)*\Delta^a_r(\Phi)(x))$ und formen um
\begin{align*}
	...
	&=\Im(\sum_{\substack{e\in E\\p(e)=x}} (\overline{\phi(p(e))} \frac{1}{r(e)^2}(\Phi(p(e))-e^{\frac{a}{r}(e)}\Phi(q(e)))) \\ &+ 
	\sum_{\substack{e\in E\\q(e)=x}} (-\overline{\phi(q(e))}e^{\frac{-a}{r}} \frac{1}{r(e)^2}(\Phi(p(e))-e^{\frac{a}{r}(e)}\Phi(q(e)))))\\
	&=-\Im(\sum_{\substack{e\in E\\p(e)=x}}\frac{1}{r(e)^2} \overline{\phi(p(e))}\Phi(q(e)) e^{\frac{a}{r}(e)}  +
	\sum_{\substack{e\in E\\q(e)=x}}\frac{1}{r(e)^2} \overline{\phi(q(e))}\Phi(p(e))e^{\frac{-a}{r}(e)} )\\
	&=-\Im(\sum_{\substack{e\in E\\p(e)=x}}\frac{1}{r(e)^2} \overline{\phi(p(e))}\Phi(q(e)) e^{\frac{a}{r}(e)}  -
	\sum_{\substack{e\in E\\q(e)=x}}\frac{1}{r(e)^2} \overline{\Phi(p(e))}\phi(q(e))e^{\frac{a}{r}(e)} )\\
	&=-\text{div}(\Im(\frac{1}{r(e)^2} \overline{\Phi(p(e))}\phi(q(e))e^{\frac{a}{r}(e)}))(x)
\end{align*}
...
\begin{align*}
	...
	&=
	-\text{div}(\Im(\frac{1}{r(e)^2} \overline{\Phi(p(e))}\phi(q(e))e^{\frac{a}{r}(e)}))
\end{align*}
\end{proof}
\noindent
