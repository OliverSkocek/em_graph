...
\begin{definition}
	...
	\begin{equation}
		(\frac{\partial}{\partial t} - \phi)^2\Phi - \Delta^a_{r^{-2}}\Phi+ m \Phi = 0
	\end{equation}
...
L\"osung der Klein-Gordongleichung
	\begin{equation}
	(\frac{\partial}{\partial t} - (\phi-\xi^\prime))^2\tilde{\Phi} - \Delta^{a + \text{grad}\xi}_{r^{-2}}\tilde{\Phi}+ m \tilde{\Phi} = 0
\end{equation}
\end{proposition}
\begin{proof}
	content...
