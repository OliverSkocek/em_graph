...
\begin{theorem}
	Sei $G$ ein planarer Graph, $\epsilon\equiv 1$ und $r>0$ Kantenfunktionen, $\mu\equiv 1$ eine Fl\"achenfunktion, dann existiert eine orthogonale Abbildung $U$ auf $\mathfrak{K}$ und $(\omega_j)_{j=1}^{|f|-1}>0$ sodass gilt:
	\begin{equation}
