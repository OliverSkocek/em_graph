...
\end{equation*} 
Wir wissen wegen dem de'Rham Komplex Theorem, und weil $r>0$ ist, dass es eine  $\chi:img(\text{grad})\mapsto \mathbb{R}^\perp$ gibt, sodass gilt:
\begin{equation*}
...
\begin{equation*}
0=\text{grad}(\xi^\prime(t))+\text{grad}(\phi(t))
\end{equation*} 
