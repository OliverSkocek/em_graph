...
\begin{theorem}
	Sei $G$ ein planarer Graph, $\epsilon\equiv 1$ und $r>0$ Kantenfunktionen, $\mu\equiv 1$ eine Fl\"achenfunktion, dann existiert eine orthogonale Abbildung $U$ auf $\mathfrak{K}$ sodass:
	\begin{equation}
	\hat{H}\circ U  = \sum_{j=1}^{|E|}h_j
	\end{equation}
	Wobei $g_j$ freie Hamiltonoperatoren sind und $h_j$ harmonische Oszillatoren, also:
\[h_j= \begin{cases} 
