...
\begin{proof}
	...
	\end{equation*}
und somit der Kenr von $\hat{N}_\omega$ mit dem von $\hat{a}_\omega$ \"ubereinstimmt.\\
\\
...
Betrachten wir hierzu $n+1$ und nehmen an es gibt  zuge\"orende linear unabh\"angige Eigenvektoren $\psi_a$ und $\psi_b$.\\
Nachdem $\hat{a}_\omega\psi_a$ und $\hat{a}_\omega\psi_b$ Eigenvektoren zu $n$ sind m\"ussen diese linear abh\"angig sein daher gibt es $u1\neq0$ und $u_2\neq 0$ sodass:
\begin{equation*}
...
Das einzige Element des Eigenraums zu $n+1$, die das erf\"ullt ist der Nullvektor.\\
\\
