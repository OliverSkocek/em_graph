...
\begin{definition}
	...
	Sei $G$ ein planarer Graph, $r>0\in\mathfrak{K}$ und $\psi\in L^2(\mathfrak{E}_{\mathbb{C}}\times(\mathfrak{T}+\text{kern}(\text{div r})),\mathbb{C})$, dann definieren wir den Hilbertraum der Quantenelektrodynamik \"uber
	\begin{equation}
		\psi\in\mathfrak{H}_{qed}\equiv\exists \tilde{\psi}\in L^2(\mathfrak{E}_{\mathbb{C}}\times\mathfrak{K}(G),\mathbb{C}):\hat{U}_\xi(\tilde{\psi})=\tilde{\psi}\forall \xi\in\mathfrak{E}, \psi = \tilde{\psi}|_{\mathfrak{E}(G)_{\mathbb{C}}\times(\mathfrak{T}+\text{kern}(\text{div r})}
	\end{equation}
\end{definition}
\noindent
...
Hierzu habe ich im f\"unften Kapitel die Potentialformulierung der Maxwellgleichungen mit ihren Eichsymmetrien eingef\"uhrt um dann im sechsten Kapitel die kanonische Quantisierung des freien elektromagentischen Feldes durch-zuf\"uhren. Abgeschlossen wird das Kapitel mit der Einf\"urhung von Erzeugungs und Vernichtungsoperatoren und der Photoneninterpretation der Anregungen des freien Feldes.\\
...
Im letzten Kapitel konstruieren wir einen Hilbertraum auf dem wir eine Theorie der Quantenelektrodynamik auf planaren Graphen formulieren k\"onnen.\\
\\
