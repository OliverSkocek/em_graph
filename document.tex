...
\begin{equation*}
	h_j = \frac{1}{2}(\pi_j^2 + \omega_j^2 q^2)
\end{equation*}\footnote{Anstelle von $j$ schreiben wir von hier an $\omega$.}
Wir definieren als den Vernichtungsoperator $\hat{a}_\omega$
\begin{equation*}
	\hat{a}_\omega = \sqrt{\frac{\omega}{2}}(q + i \frac{1}{\omega}\pi)
\end{equation*}
Die Adjungierte des Vernichtungsoperators $\hat{a}_\omega^\dagger$ nennen wir den Erzeugungsoperator. Diese Operatoren erzeugen und vernichten etwas, dass im entferntesten Sinn als Teilchen bezeichnet werden kann, ein Teilchen der Mode $\omega$ Um diese Interpretation etwas z\"ahlbaren zu untermauern definieren wir den Teilchenzahloperator 
\begin{equation*}
	\hat{N}_\omega =\hat{a}^\dagger_\omega\hat{a}_\omega
\end{equation*}
Der Summand $h_\omega$ l\"asst sich schreiben als
\begin{equation*}
	h_\omega = \omega (\hat{N}_\omega + \frac{1}{2})
\end{equation*}
 \iffalse 
