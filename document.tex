...
\begin{definition}
	Sei $G$ ein planarer Graph $m>0$ und $\Phi_0$ sowie $v_0$ komplexe Eckfunktionen, dann nennt man $\Phi\in C^1(\mathfrak{E}, \mathbb{C})$ eine L\"osung der \textbf{Klein-Gordongleichung} falls f\"ur alle $t\in\mathbb{R}$ gilt
	\begin{equation}
...
\end{align*}
Der letzte Term muss sich im Bild der Divergenz befinden um die Inverse der Divergenz darauf anzuwenden. Dies ist nach dem de'Rham Komplex Theorem genau dann der Fall wenn die Summe der Eckfunktion \"uber alle Ecken gleich Null ist. Sei hierzu  $\Phi(e)=a(e)+ib(e)$ f\"ur alle $e\in E$ und beachte, dass $\Delta_1$ komponentenweise angewendet wird, dann gilt f\"ur den Imagin\"arteil
\begin{align*}
	&\sum_{e\in E} \Im(\overline{\Phi}\Delta_1\Phi)=\sum_{e\in E} (a(e)\Delta_1b(e) - b(e)\Delta_1a(e))=\langle a,\Delta_1b\rangle_{\mathfrak{E}}-\langle b ,\Delta_1a\rangle_{\mathfrak{E}}=\\
...
\begin{proposition}
	Sei $G$ ein planarer Graph $m>0$, $\Phi_0$ sowie $v_0$ komplexe Eckfunktionen und $\pi,\Phi\in C^1(\mathfrak{E}, \mathbb{C})$, dann nennt man
	\begin{equation}
...
\begin{definition}
	...
	\begin{equation}
		\mathfrak{H} = L^2(\mathfrak{E}(G)^2,\mathbb{C};\lambda)
	\end{equation}
