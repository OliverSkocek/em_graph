...
\end{theorem}
\begin{proof}
	Der Beweis funktioniert analog wie Theorem 6.6. Wir verwenden den positiv definiten komplexen linearen Operator
	\begin{equation*}
		Q= \Delta^{a}_r+ m^2
	\end{equation*}
,der sich nach dem Spektralsatz schreiben l\"asst als
	\begin{equation*}
	Q = U^\dagger R U
\end{equation*}
