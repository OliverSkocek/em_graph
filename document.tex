...
\end{remark}
\noindent
Die Maxwell-Gleichungen sind ein gew\"ohnliches lineares Differentialgleichungssystem und als solche gibt es keine Probleme wegen Existenz und Eindeutigkeit f\"ur jeden Zeitpunkt. Dies l\"asst sich in jedem guten Buch \"uber gew\"ohnliche Differentialgleichungen nachlesen.\\
\\
...
\begin{proposition}\textbf{Kontinuit\"atsgesetz}
	...
	$$q^\prime = - \text{div}(r*j)$$
	Dies zeigt, dass die gesamte elektrische Ladung erhalten bleibt.
\end{proposition}
\begin{proof}
	...
	Summieren wir nun die obige Gleichung \"uber alle Ecken heben sich die Beitr\"age der Kanten in $\text{div}(r*j)$ gegenseitig auf, da jede Kante einmal in dem $\text{div}$-Term der Ecke von der er wegzeigt und einmal im Term der Ecke auf die er zeigt vorkommt.
