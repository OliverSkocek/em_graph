...
\begin{definition}
	...
	\begin{equation*}
		\psi(\Phi, a) = \tilde{\psi}(\Phi e^{-iQ(a)}, (1-P_{\text{Bild}(r\text{grad})}a))\forall\Phi\in\mathfrak{E}(G)_{\mathbb{C}},\forall a\in\mathfrak{T}+\text{kern}(\text{div r})
	\end{equation*}
...
\end{proof}
\noindent
\chapter{Numerische Simulation der skalare Quantenelektrodynamik auf einem Ikosaeder}
\chapter*{Abschluss}
