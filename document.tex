...
\\
\\
Eine kurze Betrachtung der Hamiltonfunktion (6.4) zeigt eine \"Aquivalenz des Problems zu einer $|E|$ Punktma\ss{}en mit Massen $r(e)$ f\"ur jedes $e\in E$ in einem Potential. Der Hamiltonoperator des elektromagnetischen Feldes auf dem planaren Graphen $G$ l\"asst sich daher schreiben als:
\begin{equation}
	\hat{H}=-\sum_{e\in E}\frac{1}{2\epsilon(e)}\frac{\partial^2}{\partial q_e^2} + (\frac{1}{2}\langle \text{div}_D(r^{-1}q), \text{div}_D(r^{-1}q)\rangle_{\mathfrak{K}}/\mu - \langle q, j\rangle_{\mathfrak{K}})
\end{equation}	
...
\begin{theorem}[Ehrenfest Theorem]
	...
	\begin{equation}
		\langle \psi, (-\hat{\pi}\psi\rangle^\prime = 
	\end{equation}
\end{theorem}
