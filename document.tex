...
\begin{align*}
	...
	\langle r^{-1}\overline{\text{grad}^A(\Phi)}, r^{-1}\text{grad}^A(\Phi)\rangle_{\mathfrak{K}} - m^2\langle \overline{\Phi}, \Phi\rangle_{\mathfrak{E}}+ \\
	&\langle \epsilon(a^\prime + r\text{grad}(\phi)), a^\prime + r\text{grad}(\phi)\rangle_\mathfrak{K} -\\& \langle\text{div}_D(r^{-1}a), \text{div}_D(r^{-1}a)/\mu\rangle_\mathfrak{F})
\end{align*}
\chapter*{Abschluss}
