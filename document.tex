...
\begin{definition}
Sei $G$ ein planarer Graph mit Orientierung dann nennt man eine Kantenfunktion $a$ ein Vektorpotential und eine Eckfunktion $\phi$ ein Skalarpotential falls
	\begin{align}
		b = \text{div}_D(a) \\
		e = -a^\prime - \text{grad}(\phi)
	\end{align}
\end{definition}
\noindent
...
Wir fordern nun zus\"atzlich zu den Maxwellgleichungen, dass das Magnetfeld $b$ orthogonal zu den konstanten Fl\"achenfunktionen ist: 
$$b\in \mathbb{R}^\perp$$
