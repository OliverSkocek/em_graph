...
\begin{proof}
	...
	Fassen wir zusammen:
	$$E^\prime = -\langle e, r^{-1} * j\rangle_{\mathfrak{K}}$$
\end{proof}
...
\end{proof}
\noindent
Wir haben nun gezeigt, dass sich der freie Hamiltonoperator (6.13), daher mit $\hat{j}\equiv 0$, zerlegen l\"asst in eine endliche Summe von selbstadjungierten Operatoren mit bekannten Spektra. Widmen wir uns nun einer detailierteren Analyse des gefundenen Spektrums.

\chapter{Zweite Quantisierung der Maxwellgleichungen}
Das elektromagnetische Feld tauscht Energie in Quanten oder festen Portionen mit der Materie aus. Die Energieportionen nennt man Photonen und die Energie $E$ eines Photons ist proportional zu seiner Frequenz $\nu$. Diese Eigentschaft der Quantentheorie des elektromagnetischen Feldes spiegelt sich noch nicht in unserer Beschreibung wieder. Wir m\"ussen ausgehend 
\chapter*{Abschluss}
