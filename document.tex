...
\end{align*}
Es kann dann gezeigt werden, dass die Eigenwerte des Besetzungszahloperators $\hat{N}_\omega$ genau die nat\"urlichen Zahlen sind und die zugeh\"origen Eigenr\"aume eindimensional sind.\footnote{Dies wird im Anhang gezeigt.}
\\
\\
