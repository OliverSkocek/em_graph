...
\begin{definition}
	Sei $G$ ein planarer Graph $m>0$ und $\Phi_0$ sowie $v_0$ Kurven von Eckfunktionen, dann nennt man $\Phi\in C^1(\mathfrak{E}, \mathbb{R})$ eine L\"osung der \textbf{Klein-Gordongleichung} falls f\"ur alle $t\in\mathbb{R}$ gilt
	\begin{equation}
