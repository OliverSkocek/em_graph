...
\end{proof}
\noindent
Die Voraussetzung $m>0$ im Hilfssatz 7.7 ist tats\"achlich notwendig, da im Fall $m=0$ und nichttrivialen Kern von $L$ die Konstruktion einer solchen Wahrscheinlichkeit und damit Assoziation mit einem Knoten(Ort) nicht m\"oglich ist.
\\
\\
