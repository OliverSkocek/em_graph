...
\begin{proof}
	...
	\end{equation*} 
\end{proof}
Der Operator $H$ ist indefinit und seine Eigenwerte sind symmetrisch um Null.
\begin{proposition}
	...
	gegeben durch 
		\begin{equation}
		\sigma(H)= \{\pm\sqrt{\omega+m^2}:\omega^2\in \sigma(L)\}
	\end{equation} 
\end{proposition}
\begin{proof}
	Sei $u$ sodass $Au = \omega^2 u$, $a\in\mathbb{C}$ dann konstruieren wir die Eigenvektoren
	\begin{equation*}
		v=\begin{pmatrix}
			u \\ a*u
		\end{pmatrix}
	\end{equation*}
	Wenden wir als n\"achstes die Matrix $H$ auf $v$ and und erhalten
	\begin{align*}
		content...
	\end{align*}
\end{proof}
\begin{proposition}
	...
	\begin{equation}
		...
		\end{pmatrix}J
	\end{equation}
	ein selbstadjungierter Operator ist.
\end{proposition}
 Da er selbstadjungiert ist bleibt die Norm von $\psi$ unter der Klein-Gordon Zeitentwicklung erhalten.\\
