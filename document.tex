...
\\
Die Klein-Gordongleichung ist so konstruiert, dass eine L\"osung einer Gleichung durch Multiplikation mit einer lokalen Phase wieder eine L\"osung einer Klein-Gordongleichung ist. Diese Transformation lehnt sich an die Eichtransformation der Maxwelltheorie an und erweitert Diese. Diese erweiterte Eichtransformation dient zur Kopplung des Klein-Gordon Feldes mit den Feldern der Maxwelltheorie. 
\begin{definition}
...
\begin{definition}
	...
	\begin{equation}
		\hat{H}=-\sum_{k\in V}2\overline{\partial_k}\partial_k + \frac{1}{2}(\langle r^{-1}\text{grad}_r^a(\Phi), r^{-1}\text{grad}_r^a(\Phi)\rangle_{\mathfrak{K},\mathbb{C}}+ m^2\langle\Phi, \Phi\rangle_{\mathfrak{E},\mathbb{C}})
	\end{equation}
