...
\begin{definition}
	Sei $G$ ein planarer Graph, $a$ eine Kantenfunktion und $\Phi$ eine komplexe Eckfunktion, dann ist der \textbf{Eichgradient} f\"ur jede Kante $e\in E$ definiert durch:
	\begin{equation}
		\text{grad}^a(\Phi)(e) = \Phi(p(e)) - \Phi(q(e))e^{ia(e)}
	\end{equation}
	Sei weiters $r>0$ eine Kantenfunktion und $v\in V$ , eine Ecke dann nennen wir 
		\begin{equation}
		\Delta^a_r(\Phi)(v) = (\text{grad}^a)^\dagger(r*\text{grad}^a(\Phi)(v))
	\end{equation} 
	den Eich-Laplace Operator. Man beachte das sich die Adjunktion $\dagger$ auf das komplexe Skalarprodukt bezieht.
\end{definition}
\begin{lemma}
	Sei $G$ ein planarer Graph, $a$ eine reele und $\xi$ eine komplexe Kantenfunktion, sodass $|\xi|=1$ gilt.  F\"ur jede komplexe Eckfunktion $\Phi$ gilt dann f\"ur jede Kante $e$.
	\begin{equation}
		\text{grad}^{a+\text{grad}(\xi)}a(e^{i\xi(e)}\Phi)(e)=e^{i\xi(p(e))}\text{grad}^a(\Phi)(e)
	\end{equation}
\end{lemma}

\begin{definition}
	Sei $G$ ein planarer Graph, $m>0$ eine reele Zahl, $r>0$, $a$ Kantenfunktionen und $\Phi_0$ sowie $v_0$ komplexe Eckfunktionen, dann nennt man $\Phi\in C^1(\mathfrak{E}, \mathbb{C})$ eine L\"osung der \textbf{Klein-Gordongleichung} falls f\"ur alle $t\in\mathbb{R}$ gilt
	\begin{equation}
		\Phi^{\prime \prime} - \Delta^a_{r^{-2}}\Phi+ m \Phi = 0
	\end{equation}
...
\begin{proposition}
	Sei $G$ ein planarer Graph, $m>0$ eine reele Zahl, $r>0$, $a$ Kantenfunktionen und $\Phi$ eine L\"osung der Klein-Gordongleichung zur Anfangsbedingung $\phi_0\in\mathfrak{E}$ , dann gilt die Kontinuit\"atsgleichung:
	\begin{equation}
		q^\prime + \text{div}(j) = 0 
	\end{equation}
	...
	\begin{align}
		...
		&j = -\text{div}^{-1}\Im(\overline{\Phi}\Delta^a_{r^{-2}}(\Phi))
	\end{align}
\end{proposition}
\begin{proof}
...
\begin{align*}
	...
	\frac{1}{2i}(\overline{\Phi}*(\Delta^a_{r^{-2}}\Phi - m \Phi)-\Phi*\overline{(\Delta^a_{r^{-2}}\Phi - m \Phi)})=\\
	&\frac{1}{2i}(\overline{\Phi}*\Delta^a_{r^{-2}}\Phi-\Phi*\overline{\Delta^a_{r^{-2}}\Phi})=\Im(\overline{\Phi}*\Delta^a_{r^{-2}}(\Phi))
\end{align*}
...
\begin{equation*}
	\sum_{v\in V}\Im(\overline{\Phi}*\Delta^a_{r^{-2}}(\Phi))=\Im(\sum_{v\in V}\overline{\Phi}*\Delta^a_{r^{-2}}(\Phi))=\Im(\langle\Phi, \Delta^a_{r^{-2}}(\Phi)\rangle_{\mathfrak{E}})
\end{equation*}
...
\begin{equation*}
	q^\prime =\Im(\overline{\Phi}*\Delta^a_{r^{-2}}(\Phi))=\text{div}(\text{div}^{-1}(\Im(\overline{\Phi}*\Delta^a_{r^{-2}}(\Phi))))
\end{equation*}
\end{proof}
\noindent
