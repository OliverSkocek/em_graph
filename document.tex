...
\begin{proposition}
	Sei $G$ ein planarer Graph und $\psi\in F(\mathfrak{E}_\mathbb{C}(G)\times\mathfrak{K}(G), \mathbb{C})$, dann ist $\psi$ genau dann invariant unter $\hat{U}_\xi$ f\"ur beliebiges $\xi\in\mathfrak{E}(G)$ mit $\sum_{x\in V}\xi(x)=0$ falls es ein $f\in F(\mathfrak{E}_\mathbb{C}(G)\times\text{kern}(\text{div r}), \mathbb{C})$ gibt sodass f\"ur alle $\Phi\in\mathfrak{E}_\mathbb{C}(G)$ und $a\in\mathfrak{K}(G)$ gilt
	\begin{equation}
		\psi(\Phi, a) = f(\Phi e^{-iQ(a)}, (1-P_{\text{Bild}(r\text{grad})})a)
	\end{equation}
	Wobei $Q$ die Pseudoinverse von $r\text{grad}$ ist.
\end{proposition}
\begin{proof}
Sei $\psi\in F(\mathfrak{E}_\mathbb{C}(G)\times\mathfrak{K}(G), \mathbb{C})$ f\"ur beliebiges $\xi\in\mathfrak{E}(G)$ mit $\sum_{x\in V}\xi(x)=0$ invariant, dann definieren wir $f\in F(\mathfrak{E}_\mathbb{C}(G)\times\text{kern}(\text{div r}), \mathbb{C})$ als die Einschr\"ankung von $\psi$ auf $\mathfrak{E}_\mathbb{C}(G)\times\text{kern}(\text{div r})$.\\
Unter Ausnutzung der Eichinvarianz von $\psi$ gilt dann:
\begin{align*}
	\psi(\Phi, a) &= \psi(\Phi e^{-iQa}, a-r\text{grad}Qa)=\psi(\Phi e^{-iQa}, (1-P_{\text{Bild}(r\text{grad})})a)\\&=f(\Phi e^{-iQa}, (1-P_{\text{Bild}(r\text{grad})})a)
\end{align*}
...
\begin{align*}
	\psi(\Phi e^{i\xi}, a + r\text{grad}\xi) &= f(\Phi e^{i\xi} e^{-iQ(a + r\text{grad}\xi)}, (1-P_{\text{Bild}(r\text{grad})})a)\\&=f(\Phi e^{-iQ(a )}, (1-P_{\text{Bild}(r\text{grad})})a)=\psi(\Phi, a)
\end{align*}
\end{proof}
\noindent
\begin{corollary}
...
\end{definition}
\begin{lemma}
	Sei $G$ ein planarer Graph, dann gilt $\psi\in \mathfrak{H}_{\text{sym}}$ wenn es ein $f\in F(\mathbb{R}^{\{y\}}\times\mathbb{C}^{V-\{y\}}, \mathbb{C})$ gibt sodass f\"ur alle $\Phi\in\mathfrak{E}_\mathbb{C}(G)$ gilt
	\begin{equation}
...
\end{proof}
\noindent
Dieser Satz gibt uns eine explizite Konstruktion des Raums der Funktionen $\phi\in F(\mathfrak{E}_\mathbb{C}(G), \mathbb{C})$, die invariant unter globaler Rotation sind, daher unter Rotation jeder Ecke um denselben Winkel. 
\begin{definition}
	Sei $G$ ein planarer Graph, $r>0\in\mathfrak{K}$ und $\psi\in L^2(\mathfrak{E}_{\mathbb{C}}\times(\mathfrak{T}+\text{kern}(\text{div r})),\mathbb{C})$, dann sagen wir $\psi\in\mathfrak{H}_{qed}$ genau dann wenn es ein $\tilde{\psi}\in F(\mathfrak{E}_{\mathbb{C}}\times \text{kern}(\text{div r}), \mathbb{C})$ gibt sodass die Einschr\"ankung von $\tilde{\psi}$ auf die erste Koordinate $\Phi\in\mathfrak{E}_{\mathbb{C}}$ Element von $\mathfrak{H}_{\text{sym}}$ ist und $\psi$ sich \"uber $\tilde{\psi}$ nach (10.10) darstellen l\"asst als
	\begin{equation}
		\psi(\Phi, a) = \tilde{\psi}(\Phi e^{-iQ(a)}, (1-P_{\text{Bild}(r\text{grad})}a))
	\end{equation}
	f\"ur beliebige $\Phi\in\mathfrak{E}(G)_{\mathbb{C}}$ und $a\in\mathfrak{T}+\text{kern}(\text{div r})$.
\end{definition}
\noindent
\begin{proposition}
...
\end{proof}
\noindent
\chapter{Numerische Simulation der skalaren Quantenelektrodynamik auf einem Ikosaeder}
\chapter*{Abschluss}
