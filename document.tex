...
\end{definition}
\noindent
Die Klein-Gordongleichung ist im kontinuierlichen Fall die einfachste Form eine Lorentz invariante Feldgleichung f\"ur Materie anzuschreiben.\\
\\
...
\begin{align*}
	...
	&-\langle r^{-1}\text{grad}(a),r^{-1}\text{grad}(b)\rangle_{\mathfrak{E}}+\langle r^{-1}\text{grad}(b) , r^{-1}\text{grad}(a)\rangle_{\mathfrak{E}}=0
\end{align*}
...
\begin{proposition}
	...
	\begin{equation}
	H(\Phi, \pi) = \frac{1}{2}(\langle \pi, \pi\rangle_{\mathfrak{E}}+\langle r^{-1}\text{grad}(\Phi), r^{-1}\text{grad}(\Phi)\rangle_{\mathfrak{E}}+m^2\langle \Phi,\Phi\rangle_{\mathfrak{E}})
	\end{equation}	
...
\begin{definition}
	...
	\begin{equation}
		\hat{H}=-\sum_{k\in V}\frac{1}{2}\frac{\partial^2}{\partial q_k^2} + \frac{1}{2}(\langle r^{-1}\text{grad}(\Phi), r^{-1}\text{grad}(\Phi)\rangle_{\mathfrak{E}}+ m^2\langle\Phi, \Phi\rangle_{\mathfrak{E}})
	\end{equation}
	Sei $\psi_0\in\mathfrak{H}$ und $\psi\in C^1(\mathbb{R},\mathfrak{H})$, sodass:
	\begin{equation}
		\hat{H}\psi(t) = i\psi^\prime(t)
...
Um die Klein-Gordontheorie mit der Maxwelltheorie zu verbinden fordern wir die so genannte lokale $U(1)$-Eichinvarianz. Dies bedeutet, dass wir fordern,
\chapter*{Abschluss}
